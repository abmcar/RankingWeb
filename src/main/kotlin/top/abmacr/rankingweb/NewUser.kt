...
class NewUser : HttpServlet() {
    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        var nowSql = "INSERT INTO ranking (sno,sname) VALUES ($nowSno,$nowName)"
        try {
            stat.execute(nowSql)
...
//            e.printStackTrace()
        ...
        if (now_name_zzulioj.isEmpty())
            ...
            out.println("<h1>数据库中zzulioj已存在</h1>")
        else {
        ...
        if (now_name_codeforces.isEmpty())
            ...
            out.println("<h1>数据库中codeforces已存在</h1>")
        else {
        ...
        if (now_name_nowcoder.isEmpty())
            ...
            out.println("<h1>数据库中nowcoder存在</h1>")
        else {
        ...
        if (now_name_fuquanoj.isEmpty())
            ...
            out.println("<h1>数据库中fuquan存在</h1>")
        else {
